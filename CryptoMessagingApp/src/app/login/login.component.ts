...
export class LoginComponent implements OnInit {
  ...
  public passwordConf:string;conf: boolean = true;
  public temp: string="";//this is for addidng empty data when started
...
signIn():void{
  try {
if(this.username!=""&& this.password!="" && this.login==true&& this.conf==false){//this allows logging in
